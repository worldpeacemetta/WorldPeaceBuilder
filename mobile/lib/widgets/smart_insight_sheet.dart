        ...
        child: AnimatedBuilder(
          ...
          builder: (_, __) => Stack(
            children: [
              ...
              Positioned(
                left: 6, top: 10,
                child: _Star(size: 26, color: widget.color,
                    scale: _sc1.value, opacity: _op1.value),
              ),
              // Medium star — upper-right
              Positioned(
                right: 0, top: 0,
                child: _Star(size: 17, color: widget.color,
                    scale: _sc2.value, opacity: _op2.value),
              ),
              // Small star — lower-right
              Positioned(
                right: 1, bottom: 0,
                child: _Star(size: 11, color: widget.color,
                    scale: _sc3.value, opacity: _op3.value),
              ),
            ],
          ),
        ),
